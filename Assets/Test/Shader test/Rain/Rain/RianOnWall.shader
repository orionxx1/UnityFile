Shader "MyShader/RianOnfloor"
{
    Properties
    {
        ...
        _SplatsSize("溅射整体尺寸", Range(0.0, 1.0)) = 1       
        _SplatsIntensity ("溅射密度", Range(0.0, 1.0)) = 1       
        _SplatsNoise ("溅射扭曲", Range(0.0, 0.1)) = 0.02        
        _SplatOffest ("随机偏移", Range(0.0, 0.5)) = 0.1      
        _SplatsScale("溅射尺寸", Range(0.0, 1)) = 0.5   
        _SplatsSpeed("溅射速度", Range(0.0, 1)) = 0.1
        _SplatsHeight("溅射凹凸", Range(0.0, 1)) = 0.   

        _DropletsSize("水滴整体尺寸", Range(0.0, 1.0)) = 1       
        _DropletsIntensity ("水滴密度", Range(0.0, 1.0)) = 1     
        _DropletsNoise ("水滴扭曲", Range(0.0, 0.3)) = 0.02      
        _DropletMaxLength ("水滴最大长度", Range(0.0, 1.0)) = 1  
        _DropletMinLength ("水滴最大小度", Range(0.0, 1.0)) = 1  
        _DropletSpeed("水滴速度", Range(0.0, 1)) = 0.1
        _DropletHeight("水滴凹凸", Range(0.0, 1)) = 0.1   
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Assets/Test/Shader test/Rain/Rain/Input_RianOnWall.hlsl"
            #include "Assets/Test/Shader test/Rain/Rain/ForwardPass_RianOnWall.hlsl"
